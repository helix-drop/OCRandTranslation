...
fn build_doc_status_json(db_path: &str, doc_id: &str) -> PyResult<String> {
    ...
    let payload = serde_json::json!({
        ...
        "summary": serde_json::json!({
            "heading_review_summary": v!(&summary.toc.heading_review_summary),
            "heading_graph_summary": v!(&summary.toc.heading_graph_summary),
            "chapter_source_summary": v!(&summary.toc.chapter_source_summary),
            "toc_alignment_summary": v!(&summary.toc.toc_alignment_summary),
            "toc_semantic_summary": v!(&summary.toc.toc_semantic_summary),
            "toc_role_summary": v!(&summary.toc.toc_role_summary),
            "container_titles": &summary.toc.container_titles,
            "post_body_titles": &summary.toc.post_body_titles,
            "back_matter_titles": &summary.toc.back_matter_titles,
