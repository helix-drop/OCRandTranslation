...
class SQLiteMainlineTest(ClientCSRFMixin, unittest.TestCase):
    ...
    def test_settings_page_separates_translation_and_visual_model_options(self):
        ...
        visual_panel_start = html.index('data-panel="visual-pool"')
        visual_panel_end = html.index('data-panel="concurrency"', visual_panel_start)
        visual_panel_html = html[visual_panel_start:visual_panel_end]
        self.assertIn('name="visual_model_pool_slot1_builtin_key"', visual_panel_html)
        self.assertNotIn('value="qwen_mt"', visual_panel_html)
