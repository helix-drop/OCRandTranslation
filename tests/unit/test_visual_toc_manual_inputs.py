...
_attach_selected_tests(
    ...
    [
        ...
        "test_merge_manual_toc_organization_nodes_coalesces_same_page_short_and_long_chapter_variants",
        ...
        "test_augment_manual_toc_organization_with_ocr_containers_skips_equivalent_expanded_part_titles",
