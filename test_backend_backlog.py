...
class BackendBacklogTest(ClientCSRFMixin, unittest.TestCase):
    ...
    def test_resolve_visual_item_persists_pdf_page_target(self):
        ...
        self.assertEqual(
            load_auto_visual_toc_from_disk(doc_id),
            [
                {
                    "item_id": "visual-1",
                    "title": "第一章",
                    ...
                    "resolution_source": "manual_pdf_page",
                }
            ],
        )
    ...
    def test_glossary_retranslate_preview_uses_last_entry_idx_and_counts_segments(self):
    ...
    def test_retranslate_page_with_current_glossary_preserves_manual_and_prior_segments(self):
        ...
        self.assertEqual(page_stats["skipped_manual_segments"], 1)
