...
/// - `char_start / char_end`：命中区间在 body 内的 Python 字符索引（与 BodySpan 单位一致）
/// - `matched_text`：按字符索引取得的命中文本
...
mod tests {
    ...
    #[test]
    fn test_char_offsets_match_python_character_indices() {
